                ...
                <Container>
                    <div className="max-w-3xl text-left">
                        <div className="inline-block px-4 py-1.5 rounded-full bg-[#f4c430]/10 border border-[#f4c430]/20 mb-6">
                            <p className="text-[#f4c430] font-black text-[10px] uppercase tracking-[0.4em] leading-none">CINEMATIC SERIES</p>
                        </div>
                        <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-[0.85] mb-8">HUMAN <br /><span className="text-[#f4c430]">DOCUMENTARIES</span></h1>
            ...
            <section className="py-16 bg-stone-50">
                <Container>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {films.map((film, i) => (
                            <div key={i} className="bg-white rounded-2xl border border-stone-100 shadow-sm hover:shadow-lg hover:translate-y-[-2px] transition-all duration-300 group overflow-hidden relative text-left flex flex-col">
                                <div className="aspect-[4/5] relative">
                                    ...
                                    <button className="absolute inset-0 m-auto w-12 h-12 rounded-full bg-[#f4c430] flex items-center justify-center text-white shadow-lg hover:scale-110 transition-all opacity-0 group-hover:opacity-100">
                                        <Play className="fill-white ml-0.5" size={18} />
                                    </button>
                                    <div className="absolute top-4 left-4">
                                        <div className="bg-[#20b2aa] text-white px-2 py-1 rounded text-[7px] font-black uppercase tracking-widest shadow-sm">New</div>
                                    </div>
                                </div>

                                <div className="p-6">
                                    <div className="flex items-center justify-between mb-3">
                                        <p className="text-[#20b2aa] font-black text-[9px] uppercase tracking-[0.3em]">✦ {film.type}</p>
                                        <p className="text-stone-400 font-black text-[9px] uppercase tracking-widest">{film.year}</p>
                                    </div>
                                    <h3 className="text-xl font-black uppercase tracking-tighter mb-3 text-stone-800 leading-tight">{film.title}</h3>
                                    <p className="text-stone-500 font-medium text-sm leading-relaxed mb-6">
                                        {film.desc}
                                    </p>
                                    <button className="w-full py-3 border border-stone-200 rounded-xl text-[9px] font-black uppercase tracking-widest text-[#f4c430] hover:bg-[#f4c430] hover:text-white transition-all">WATCH FILM</button>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={idx} className="group text-center">
                                <div className="w-20 h-20 mx-auto rounded-full border-2 border-white/30 flex items-center justify-center mb-3 group-hover:border-[#f4c430] group-hover:bg-[#f4c430]/10 transition-all duration-300 backdrop-blur-sm">
                                    <Award className="w-6 h-6 text-white/60 group-hover:text-[#f4c430] transition-colors" />
                                </div>
                                <h3 className="text-white font-black text-sm uppercase tracking-widest mb-1 group-hover:text-[#f4c430] transition-colors">
                                    {festival.name}
                                </h3>
                    ...
                    <div className="mt-12 text-center">
                        ...
                        <div className="flex justify-center gap-3">
                            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                                <span className="text-[#f4c430] font-black text-base">4</span>
                                <span className="text-white/80 text-xs font-medium ml-2 uppercase tracking-widest">Awards</span>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                                <span className="text-[#f4c430] font-black text-base">12</span>
